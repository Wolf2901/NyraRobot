...
import NyraRobot.modules.sql.userinfo_sql as sql
...
from NyraRobot import telethn as NyraTelethonClient
from NyraRobot.__main__ import STATS, TOKEN, USER_INFO
from NyraRobot.modules.disable import DisableAbleCommandHandler
from NyraRobot.modules.helper_funcs.chat_status import sudo_plus
from NyraRobot.modules.helper_funcs.extraction import extract_user
from NyraRobot.modules.sql.afk_sql import check_afk_status, is_afk
from NyraRobot.modules.sql.global_bans_sql import is_user_gbanned
from NyraRobot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if user_id not in [bot.id, 777000, 5278339583]:
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/Nyra_Update"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/Nyra_Update"
                            ),
                        ],
                    ]
                ),
...
def set_about_me(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if repl_user_id in [bot.id, 777000, 5278339583] and (user_id in DEV_USERS):
